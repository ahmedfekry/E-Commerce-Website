    ...
    <div class="wrap">
	    ...
	    <div class="main">
	        ...
	        <div class="rows">
				...
				$sql = "select id FROM `order_processing` WHERE order_processing.date + (30 ) < now() and order_processing.processed = 0";    // query
				...
				while($row = $result->fetch_assoc())
				{
					...
					$q = $row['quantity'];
					$sql2 = "update product 
							set product.quantity_in_stock = product.quantity_in_stock +	'$q'					
							where id = '$i'	
							;";    // query
					$result2 = mysqli_query($conn, $sql2);
					
					$sql2 = "delete FROM `order_processing` WHERE order_processing.id = $i
							";    // query
					$result2 = mysqli_query($conn, $sql2);
