...
<?php 
  ...
  $query =  "SELECT * FROM order_processing WHERE customer = '$customer' ";
		 ...
		 while($obj = $result->fetch_object())
		    	{
					...
					echo "<form>";
				    echo '<tr>
		      	    		<td class="col-md-2" ><span style="font-size:16px" class="fancy-blue">
                    <input type="hidden" name = "orderId" value = '.$obj->id.'></input>'.$obj->id.'<input type="hidden" name = "productId" value = '.$obj->product.'></spen></td>
                            ...
                            <td class="col-md-2">
                             ...
                             <td class="col-md-2">
                              <span style="font-size:16px" class="fancy-blue">'.$currency.$row->price.'</span>
  							 ...
  							 <td class="col-md-2">
                              <span style="font-size:16px" class="fancy-blue"><input name ="numberOfProducts2" type ="number" value = '.$obj->quantity.' min = "1" max = '.$row->quantity_in_stock.' /></span>
                             </td>
  							<td class="col-md-2">
